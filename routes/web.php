...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::group(['middleware' => 'kurikulum'], function(){
        ...
        Route::prefix('rpp')->group(function(){
            Route::get('/list', [KurikulumController::class, 'listRPP'])->name('list-rpp');
            Route::get('/add', [KurikulumController::class, 'getRPP'])->name('add-rpp');
            Route::post('/post', [KurikulumController::class, 'postRPP'])->name('post-rpp');
        });
    });
